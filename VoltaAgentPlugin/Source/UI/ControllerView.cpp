...
{
    return korean ("\xEC\x95\x88\xEB\x85\x95\xED\x95\x98\xEC\x84\xB8\xEC\x9A\x94. \xED\x94\x84\xEB\xA1\x9C\xEC\xA0\x9D\xED\x8A\xB8\xEC\x97\x90 \xEB\x8C\x80\xED\x95\xB4 \xEA\xB0\x84\xEB\x8B\xA8\xED\x9E\x88 \xEC\x84\xA4\xEB\xAA\x85\xED\x95\xB4\xEC\xA3\xBC\xEC\x84\xB8\xEC\x9A\x94.");
}

juce::String greetingExample()
{
    return korean ("\xEC\x98\x88: K-pop \xEB\xB0\x9C\xEB\x9D\xBC\xEB\x93\x9C / \xEC\x97\xAC\xEC\x84\xB1 \xEB\xB3\xB4\xEC\xBB\xAC \xEC\xA4\x91\xEC\x8B\xAC / \xEA\xB8\xB0\xED\x83\x80\xEC\x99\x80 \xED\x94\xBC\xEC\x95\x84\xEB\x85\xB8 \xEC\x9C\x84\xEC\xA3\xBC / \xEB\xA8\xBC\xEC\xA0\x80 \xED\x8A\xB8\xEB\x9E\x99 \xEC\xA0\x95\xEB\xA6\xAC\xEC\x99\x80 \xEB\xA1\x9C\xEC\x9A\xB0\xEC\xBB\xB7\xEB\xB6\x80\xED\x84\xB0");
}
...
{
    return korean ("\xEC\x8A\xA4\xED\x85\x9C \xEB\xB6\x84\xEC\x84\x9D\xEC\x9D\xB4 \xEC\x99\x84\xEB\xA3\x8C\xEB\x90\x98\xEC\x97\x88\xEC\x8A\xB5\xEB\x8B\x88\xEB\x8B\xA4. AI\xEA\xB0\x80 \xEC\x9D\xB4 \xED\x94\x84\xEB\xA1\x9C\xEC\xA0\x9D\xED\x8A\xB8\xEC\x9D\x98 \xEA\xB5\xAC\xEC\x84\xB1\xEA\xB3\xBC \xEB\xAF\xB9\xEC\x8B\xB1 \xEC\x8B\x9C\xEC\x9E\x91 \xEC\x88\x9C\xEC\x84\x9C\xEB\xA5\xBC \xEC\x9A\x94\xEC\x95\xBD\xED\x95\x98\xEA\xB3\xA0 \xEC\x9E\x88\xEC\x8A\xB5\xEB\x8B\x88\xEB\x8B\xA4.");
}

juce::String initialProjectBriefPromptLine()
{
    return korean ("\xED\x94\x84\xEB\xA1\x9C\xEC\xA0\x9D\xED\x8A\xB8\xEC\x97\x90 \xEB\x8C\x80\xED\x95\xB4 \xEA\xB0\x84\xEB\x8B\xA8\xED\x9E\x88 \xEC\x84\xA4\xEB\xAA\x85\xED\x95\xB4\xEC\xA3\xBC\xEC\x84\xB8\xEC\x9A\x94. \xEC\x9E\xA5\xEB\xA5\xB4, \xEB\xB3\xB4\xEC\xBB\xAC \xEC\x9C\xA0\xEB\xAC\xB4, \xEC\xA3\xBC\xEC\x9A\x94 \xEC\x95\x85\xEA\xB8\xB0, \xEC\x9B\x90\xED\x95\x98\xEB\x8A\x94 \xEC\x9E\x91\xEC\x97\x85\xEC\x9D\xB4 \xEC\x9E\x88\xEC\x9C\xBC\xEB\xA9\xB4 \xEA\xB0\x99\xEC\x9D\xB4 \xEC\x95\x8C\xEB\xA0\xA4\xEC\xA3\xBC\xEC\x84\xB8\xEC\x9A\x94.");
}
...
juce::String firstBriefPlaceholder()
{
    return korean ("\xEC\x98\x88: K-pop / \xEC\x97\xAC\xEC\x84\xB1 \xEB\xB3\xB4\xEC\xBB\xAC / \xEA\xB8\xB0\xED\x83\x80\xC2\xB7\xED\x94\xBC\xEC\x95\x84\xEB\x85\xB8 \xEC\xA4\x91\xEC\x8B\xAC / \xEB\xA8\xBC\xEC\xA0\x80 \xED\x8A\xB8\xEB\x9E\x99 \xEC\xA0\x95\xEB\xA6\xAC\xEC\x99\x80 \xEB\xA1\x9C\xEC\x9A\xB0\xEC\xBB\xB7\xEB\xB6\x80\xED\x84\xB0");
}

juce::String followupPromptPlaceholder()
{
    return korean ("\xEB\xB3\xB4\xEC\xBB\xAC\xEC\x9D\x84 \xEC\xA1\xB0\xEA\xB8\x88 \xEB\x8D\x94 \xEC\x95\x9E\xEC\x9C\xBC\xEB\xA1\x9C, \xEA\xB8\xB0\xED\x83\x80 \xED\x95\x98\xEC\x9D\xB4\xEC\xBB\xB7\xED\x95\xB4\xEC\xA4\x98 \xEA\xB0\x99\xEC\x9D\x80 \xEC\x88\x98\xEC\xA0\x95 \xEC\x9A\x94\xEC\xB2\xAD\xEC\x9D\x84 \xEC\x9E\x85\xEB\xA0\xA5\xED\x95\x98\xEC\x84\xB8\xEC\x9A\x94.");
}

juce::String firstBriefGuideText()
{
    return korean ("\xEC\xB2\xAB \xEB\xA9\x94\xEC\x8B\x9C\xEC\xA7\x80\xEB\x8A\x94 \xED\x94\x84\xEB\xA1\x9C\xEC\xA0\x9D\xED\x8A\xB8 \xEB\xB8\x8C\xEB\xA6\xAC\xED\x94\x84\xEB\xA1\x9C \xEC\xA0\x81\xEC\x96\xB4\xEC\xA3\xBC\xEC\x84\xB8\xEC\x9A\x94. \xEC\x9E\xA5\xEB\xA5\xB4, \xEB\xB3\xB4\xEC\xBB\xAC \xEC\x9C\xA0\xEB\xAC\xB4, \xEC\xA3\xBC\xEC\x9A\x94 \xEC\x86\x8C\xEC\x8A\xA4, \xEB\xA8\xBC\xEC\xA0\x80 \xED\x95\x98\xEA\xB3\xA0 \xEC\x8B\xB6\xEC\x9D\x80 \xEC\x9E\x91\xEC\x97\x85\xEC\x9D\x84 \xED\x95\xA8\xEA\xBB\x98 \xEC\xA0\x81\xEC\x96\xB4\xEC\xA3\xBC\xEC\x84\xB8\xEC\x9A\x94.");
}
...
void ControllerView::resized()
{
    ...
    auto showApprovalButtons = audioProcessor.isNamingApprovalPending() || audioProcessor.isEqCleanupApprovalPending();
...
void ControllerView::refreshState()
{
    ...
    auto projectOverview = audioProcessor.getProjectOverviewText();
    ...
    auto eqCleanupApprovalPending = audioProcessor.isEqCleanupApprovalPending();
    auto pendingEqCleanupCount = audioProcessor.getPendingEqCleanupApprovalCount();
    auto anyApprovalPending = namingApprovalPending || eqCleanupApprovalPending;

    progressValue.setText (namingApprovalPending
                               ? buildNamingApprovalGuideText (pendingNamingCount)
                               : (eqCleanupApprovalPending
                                      ? buildEqCleanupApprovalGuideText (pendingEqCleanupCount)
    ...
    assistantTitle.setText (shouldShowResultPanel
                                ? korean ("\x41\x49 \xED\x94\x84\xEB\xA1\x9C\xEC\xA0\x9D\xED\x8A\xB8 \xEB\xB6\x84\xEC\x84\x9D \xEC\x9A\x94\xEC\x95\xBD")
                                : korean ("\xEC\x8B\x9C\xEC\x9E\x91 \xEC\x88\x9C\xEC\x84\x9C"),
                            juce::dontSendNotification);
    assistantBubble.setText (shouldShowResultPanel
                                 ? (anyApprovalPending
                                        ? buildResultPanelText (explanation, plannedChanges)
                                        : buildResultPanelText (explanation, projectOverview, plannedChanges))
                                 : buildWorkflowGuide (sessionStatus, analysisStatus, hasStemFolder),
                             juce::dontSendNotification);
    userBubble.setText (audioProcessor.getLastSubmittedPromptText().isNotEmpty() ? audioProcessor.getLastSubmittedPromptText() : noUserPromptLine(),
                        juce::dontSendNotification);
    plannedChangesValue.setText (analysisComplete ? (anyApprovalPending
                                                           ? (plannedChanges.isNotEmpty() ? plannedChanges : explanation)
                                                           : (hasOverview ? projectOverview
    ...
    plannedChangesTitle.setText (namingApprovalPending
                                     ...
                                     : (eqCleanupApprovalPending
                                            ? juce::String::fromUTF8 (u8"로우컷 / 하이컷 제안")
    ...
    promptEditor.setTextToShowWhenEmpty (analysisComplete
                                             ? (hasSubmittedPrompt ? followupPromptPlaceholder() : firstBriefPlaceholder())
                                             : korean ("\xEB\xB6\x84\xEC\x84\x9D\xEC\x9D\xB4 \xEC\x99\x84\xEB\xA3\x8C\xEB\x90\x98\xEB\xA9\xB4 \xEC\x97\xAC\xEA\xB8\xB0\xEC\x97\x90 \xED\x94\x84\xEB\xA1\x9C\xEC\xA0\x9D\xED\x8A\xB8 \xEB\xB8\x8C\xEB\xA6\xAC\xED\x94\x84\xEB\xA5\xBC \xEC\x9E\x85\xEB\xA0\xA5\xED\x95\x98\xEC\x84\xB8\xEC\x9A\x94."),
                                         subtleTextColour);
    ...
    approveNamingButton.setEnabled (! busy && anyApprovalPending);
    rejectNamingButton.setEnabled (! busy && anyApprovalPending);
    refreshSessionButton.setVisible (! anyApprovalPending);
    chooseStemFolderButton.setVisible (! anyApprovalPending);
    analyzeStemsButton.setVisible (! anyApprovalPending);
    approveNamingButton.setVisible (anyApprovalPending);
    rejectNamingButton.setVisible (anyApprovalPending);
    ...
    approveNamingButton.setTooltip (namingApprovalPending
                                          ? juce::String::fromUTF8 (u8"제안된 트랙 네이밍과 그룹핑 결과를 적용 대기열에 올립니다.")
                                          : juce::String::fromUTF8 (u8"제안된 로우컷/하이컷 정리 결과를 승인합니다."));
    rejectNamingButton.setTooltip (namingApprovalPending
                                         ? juce::String::fromUTF8 (u8"현재 네이밍/그룹핑 제안 표시를 보류하고 다른 요청을 이어갑니다.")
                                         : juce::String::fromUTF8 (u8"현재 로우컷/하이컷 제안 표시를 보류하고 다른 요청을 이어갑니다."));
...
void ControllerView::buttonClicked (juce::Button* button)
{
    ...
    {
        if (audioProcessor.isNamingApprovalPending())
            audioProcessor.approvePendingNamingProposal();
        else if (audioProcessor.isEqCleanupApprovalPending())
            audioProcessor.approvePendingEqCleanupProposal();
    }
    else if (button == &rejectNamingButton)
    {
        if (audioProcessor.isNamingApprovalPending())
            ...
            audioProcessor.rejectPendingEqCleanupProposal();
    }
                                                  ...
                                                  bool hasStemFolder) const
{
    ...
    {
        if (audioProcessor.getLastSubmittedPromptText().isEmpty())
            return korean ("\xEB\xB6\x84\xEC\x84\x9D\xEC\x9D\xB4 \xEC\x99\x84\xEB\xA3\x8C\xEB\x90\x98\xEC\x97\x88\xEC\x8A\xB5\xEB\x8B\x88\xEB\x8B\xA4. \xEC\x9D\xB4\xEC\xA0\x9C \xEC\x98\xA4\xEB\xA5\xB8\xEC\xAA\xBD \xEC\xB1\x84\xED\x8C\x85\xEC\x97\x90 \xED\x94\x84\xEB\xA1\x9C\xEC\xA0\x9D\xED\x8A\xB8 \xEB\xB8\x8C\xEB\xA6\xAC\xED\x94\x84\xEB\xA5\xBC \xEC\xA0\x81\xEC\x96\xB4\xEC\xA3\xBC\xEC\x84\xB8\xEC\x9A\x94.");
...
juce::String ControllerView::buildEqCleanupApprovalGuideText (int pendingCount) const
{
    if (pendingCount > 0)
    {
        return juce::String::fromUTF8 (u8"로우컷과 하이컷 제안이 준비되었습니다. ")
             + juce::String (pendingCount)
             + juce::String::fromUTF8 (u8"개 필터 제안을 검토한 뒤 아래 승인 또는 거절 버튼을 눌러주세요.");
    }

    return juce::String::fromUTF8 (u8"로우컷과 하이컷 제안이 준비되었습니다. 아래 승인 또는 거절 버튼을 눌러주세요.");
}
...
juce::String ControllerView::buildChatGuideText (const juce::String& analysisStatus) const
{
    ...
    {
        if (audioProcessor.getLastSubmittedPromptText().isEmpty())
            return firstBriefGuideText();

        return juce::String::fromUTF8 (u8"보컬을 조금 앞으로 빼줘, 기타 하이컷해줘 같은 수정 요청을 입력하세요.");
    }
...
juce::String ControllerView::buildResultPanelText (const juce::String& explanation,
                                                   const juce::String& plannedChanges) const
{
    auto trimmedExplanation = explanation.trim();
    auto trimmedPlannedChanges = plannedChanges.trim();
    juce::StringArray lines;

    if (trimmedExplanation.isNotEmpty()
        && trimmedExplanation != "Reply ready"
        && trimmedExplanation != initialProjectBriefPromptLine())
    {
        lines.add (trimmedExplanation);
    }

    if (trimmedPlannedChanges.isNotEmpty()
        && trimmedPlannedChanges != trimmedExplanation
        && trimmedPlannedChanges != previewPlaceholder())
    {
        if (lines.isEmpty())
            lines.add (korean ("\xEC\xA0\x9C\xEC\x95\x88 \xEA\xB2\xB0\xEA\xB3\xBC"));
        else
            lines.add ("");

        lines.add (trimmedPlannedChanges);
    }

    if (lines.isEmpty())
        lines.add (korean ("\xEC\x95\x84\xEC\xA7\x81 \xED\x91\x9C\xEC\x8B\x9C\xED\x95\xA0 \xEB\xB6\x84\xEC\x84\x9D \xEA\xB2\xB0\xEA\xB3\xBC\xEA\xB0\x80 \xEC\x97\x86\xEC\x8A\xB5\xEB\x8B\x88\xEB\x8B\xA4."));
...
juce::String ControllerView::buildResultPanelText (const juce::String& explanation,
                                                   ...
                                                   const juce::String& plannedChanges) const
{
    auto trimmedOverview = overviewText.trim();
    if (trimmedOverview.isNotEmpty())
        return trimmedOverview;

    return buildResultPanelText (explanation, plannedChanges);
}
